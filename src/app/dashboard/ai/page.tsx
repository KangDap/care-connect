      ...
      unavailableNotice={
        <Card className="border-amber-200 bg-amber-50 p-4">
          ...
          <p className="mt-1 text-sm font-medium text-amber-800/80">
            The AI analyze API currently validates ADMIN role. This user tab is
            available in the dashboard now, and can start running analysis as
            soon as the backend exposes a user-safe endpoint or permission.
          </p>
        </Card>
      }
    />
